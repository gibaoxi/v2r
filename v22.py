...
class GitHubV2RayTester:
    def __init__(self):
        ...
        # V2Ray下载信息
        self.v2ray_version = "v5.7.0"
        self.v2ray_download_url = f"https://github.com/v2fly/v2ray-core/releases/download/{self.v2ray_version}/v2ray-linux-64.zip"
    ...
    def download_v2ray(self):
        ...
        try:
            ...
            # 下载ZIP文件
            response = requests.get(self.v2ray_download_url, timeout=60)
